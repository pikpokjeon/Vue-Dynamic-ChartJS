<template>
  <div class="search-item">
    ...
    <!-- <spinner :loading="endSpinner" ></spinner>   -->
...
const { searchChart, today, title } = this;
  ...
  computed: {
    ...
    getTime() {
      return Array.from(this.searchChart[this.title].all).map(sort);
    },
    getValue() {
      return Array.from(this.searchChart[this.title].all).map((e, i) => e.cnt);
    },
